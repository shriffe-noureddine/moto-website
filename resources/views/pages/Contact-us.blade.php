      ...
      <div id="card-1" class="card card-rotating text-center">
        ...
        <div class="face front">
          ...
          <div class="avatar mx-auto white">
            <img style="width: 200px; height: 200px;" src="/profile-image/giuseppe.jpg" class="rounded-circle img-fluid"
              alt="First sample avatar image">
          </div>
          <!-- Content -->
          <div class="card-body">
            <h4 class="font-weight-bold mt-1 mb-3">La pimpa</h4>
        ...
        <div class="face back">
          ...
          <div class="card-body">
            ...
            <ul class="list-inline list-unstyled">
              ...
              <li class="list-inline-item" >
                <a class="p-2 fa-lg pin-ic" href="https://www.linkedin.com/in/giuseppe-somare/">
    ...
    <div class="card-wrapper">
      <div id="card-2" class="card card-rotating text-center">
        ...
        <div class="face front">
          ...
          <!-- Avatar -->
          <div class="avatar mx-auto white">
            <img style="width: 200px; height: 200px;" src="/profile-image/nour.png" class="rounded-circle" alt="Second sample avatar image">
          </div>
          <!-- Content -->
          <div class="card-body">
            <h4 class="font-weight-bold mt-1 mb-3">Nech 007</h4>
        ...
        <div class="face back">
          ...
          <div class="card-body">
            ...
            <ul class="list-inline list-unstyled">
              ...
              <li class="list-inline-item" >
                <a class="p-2 fa-lg pin-ic" href="https://www.linkedin.com/in/nech988/" target="_blank">
                <i class="fa fa-linkedin" aria-hidden="true"></i>
                </a>
              </li>
              <li class="list-inline-item">
    ...
    <div class="card-wrapper">
      <div id="card-3" class="card card-rotating text-center">
        ...
        <div class="face front">
          ...
          <!-- Avatar -->
          <div class="avatar mx-auto white">
            <img style="width: 200px; height: 200px;" src="/profile-image/olaf.jpg" class="rounded-circle img-fluid"
              alt="Third sample avatar image">
          </div>
          <!-- Content -->
          <div class="card-body">
            <h4 class="font-weight-bold mt-1 mb-3">Krümelmonster</h4>
        ...
        <div class="face back">
          ...
          <div class="card-body">
            ...
            <ul class="list-inline list-unstyled">
              ...
              <li class="list-inline-item" >
                <a class="p-2 fa-lg pin-ic" href="https://www.linkedin.com/in/olaf-schmidt-fullstack/" target="_blank">
                <i class="fa fa-linkedin" aria-hidden="true"></i>
                </a>
              </li>
              <li class="list-inline-item">
